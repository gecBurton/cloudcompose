...
func TestResolveValue_ManagedCredentialsReplaceComposeFileOnes(t *testing.T) {
	...
	want := "postgres://composey:s3cret@db.eu-west-2.rds.amazonaws.com:5432/orders"
	if got != want {
		t.Errorf("got %q, want %q", got, want)
	}
}
...
func TestResolveValue_QueryParametersSurviveSubstitution(t *testing.T) {
	...
	want := "postgres://composey:s3cret@db.eu-west-2.rds.amazonaws.com:5432/orders?sslmode=require"
	if got != want {
		t.Errorf("got %q, want %q", got, want)
	}
}
